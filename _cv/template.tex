...
\usepackage[sorting=ydnt, maxbibnames=99, mincitenames=99, maxcitenames=99, style=numeric, backend=biber, defernumbers=true]{biblatex}  % For the references
...
{\bf SCOPUS ID}: \href{https://www.scopus.com/authid/detail.uri?authorId=57191699148}{57191699148} ---
    Citations: 7577, h-index: 7, Documents: 23  (2022-09-12) \\
{\bf Google Scholar}: \href{https://scholar.google.com.br/citations?user=5t_sZdMAAAAJ}{Antonio H. Ribeiro} ---
    Citations: 13126, h-index: 10, i10-index: 12 (2022-09-12)
...
\nocite{*} % The nocite should go after it because of the
