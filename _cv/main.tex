...
Portuguese (mother tongue), English (fluent), Spanish (intermediate), Swedish (basic)
...
\textbf{Journal Publications:} 17\\
\textbf{Conference Publications:} 12\\
\textbf{Workshop papers:} 7\\
\textbf{Theses:} 3\\

 \noindent
 \textbf{Citations:} 18\,401\\
 \textbf{h-index:} 11\\
 \textbf{i10-index:} 12\\
 \emph{According to Google Scholar (2023-05-12)}
\end{multicols}
\vspace{-20pt}
\end{tcolorbox}
