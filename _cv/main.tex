...
\section*{Previous Academic Positions} % Section title
...
\subsubsection*{Universities}
        ...
        \shortcventry{ Royal Institute of Technology, KTH, Sweden @ Division of Robotics, Perception and Learning  }
    { November 2023 }
    ...
    { }{}
        ...
        \shortcventry{ Laboratório Nacional de Computação Científica @ Petrópolis, RJ, Brazil (online)  }
    { October, 2023 }
    ...
    { }{}
        ...
        \shortcventry{ Imperial College, UK @ Imperial Centre for Translational and Experimental Medicine  }
    { July, 2023 }
    ...
    { }{}
        ...
        \shortcventry{ IEEE EMBS @ Germany Chapter, Göttingen (online)  }
    { May, 2023 }
    ...
    { }{}
        ...
        \shortcventry{ PUC Rio, Brazil @ Department of Mechanical Engineering  }
    { May, 2023 }
    ...
    { }{}
        ...
        \shortcventry{ INRIA Paris, France @ SIERRA team  }
    { March, 2023 }
